                ...
                {topics.map(topic => (
                  <div key={topic} className="bg-black/40 border border-white/5 rounded-2xl p-4 transition-all hover:border-primary/10">
                    ...
                    <div className="flex gap-2">
                      <button onClick={() => handleLearn(topic)} className="flex-1 bg-primary text-on-primary/20 hover:bg-primary text-on-primary text-primary hover:text-white py-2 rounded-xl text-[10px] font-black uppercase transition-all">Learn</button>
                      <button onClick={() => handleQuiz(topic)} className="flex-1 bg-white/5 hover:bg-white/10 text-stone-400 py-2 rounded-xl text-[10px] font-black uppercase transition-all">Quiz</button>
                    </div>
                  </div>
                ))}
              </div>
